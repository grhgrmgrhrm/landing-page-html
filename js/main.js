...
This file licensed to R_GENESIS (http://themeforest.net/user/r_genesis) and itÃ¢ÂÂs strictly prohibited to copy or reuse it.
	...
	rgen.vide = function (obj) {
		...
		$(obj).vide({
			...
			poster: videofile + ".jpg"
				...
				posterType: 'jpg', // Poster image type. "detect" Ã¢ÂÂ auto-detection; "none" Ã¢ÂÂ no poster; "jpg", "png", "gif",... - extensions.
